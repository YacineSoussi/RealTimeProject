...
<template>
    ...
    <div class="flex-1 mx-4">
        <input class="w-full border rounded px-2 py-2" type="text" id="textMessage"/>
    </div>
    <div>
      <font-awesome-icon type="submit" icon="paper-plane" style="cursor: pointer;" id="sendMessage" @click="onSubmit" />
    </div>
</div>
</form>
</template>

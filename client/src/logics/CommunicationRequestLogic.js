...
export default class CommunicationRequestLogic {
	static async getCommunicationRequests() {
		const result =
			await CommunicationRequestRepository.getCommunicationRequests();
	...
	static async getCommunicationRequest(id) {
		const result = await CommunicationRequestRepository.getCommunicationRequest(
			id
		);
	...
	static async createCommunicationRequest(body) {
		const result =
			await CommunicationRequestRepository.createCommunicationRequest(body);
	...
	static async updateCommunicationRequest(id, body) {
		const result =
			await CommunicationRequestRepository.updateCommunicationRequest(id, body);
	...
	static async deleteCommunicationRequest(id) {
		const result =
			await CommunicationRequestRepository.deleteCommunicationRequest(id);
